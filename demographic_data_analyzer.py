...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = ((df['education'].isin(['Bachelors', 'Masters', 'Doctorate']) & (df['salary'] == '>50K')).mean() * 100).round(1)
    lower_education_rich = ((~df['education'].isin(['Bachelors', 'Masters', 'Doctorate']) & (df['salary'] == '>50K')).mean() * 100).round(1)
    ...
    rich_min_workers = (min_workers['salary'] == '>50K').sum()
    rich_percentage = ((rich_min_workers / len(min_workers)) * 100).round(1)
    ...
    rich_percentage_per_country = ((rich_per_country / total_per_country) * 100).round(1)
